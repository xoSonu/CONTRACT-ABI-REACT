...
const InteractWithContract = () => {
  const contractAddress = "0x63973fbF7a2b3b2EA3aB623471038B16A0cC3578";
  ...
  const mintMoreToken = async () => {
    const response = await contractInstance.methods.mint(500).send({ from: "0xeA2cbDc0860177bB16E8A68107857c5Bd9EE4ee6"})
    return response;
  }
